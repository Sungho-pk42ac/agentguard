...
|---|---|---|---|---|---|
| [AX 인재전쟁 해커톤](https://hackathon.jocodingax.ai/) | 2026-07-10 | public; no auth required | "기업의 실제 문제", "예선은 AI가 심사", "성과를 증명하고, 설득하고, 납득"하는 short evidence framing | gated portal scoring, final company problem details, guaranteed ranking, or verified submission-rule claims | Keep AgentGuard slices tied to company-problem adaptation, fixture-backed commands, and a 30-second evidence story rather than broad security-platform claims. |
